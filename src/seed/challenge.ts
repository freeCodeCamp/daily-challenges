// Mock challenge for seeding in development
export const challenge = {
  title: 'Vowel Balance',
  description:
    "<p>Given a string, determine whether the number of vowels in the first half of the string is equal to the number of vowels in the second half.</p>\n<ul>\n<li>The string can contain any characters.</li>\n<li>If there's an odd number of characters in the string, ignore the center character.</li>\n</ul>",
  javascript: {
    tests: [
      {
